...
if ! test -f /buildtools/tailwindcss-musl; then
	...
	wget https://github.com/tailwindlabs/tailwindcss/releases/download/v4.1.5/tailwindcss-linux-x64-musl -O /buildtools/tailwindcss-musl
...
if ! test -f /buildtools/esbuild ; then
	...
	mkdir -p /tmp/bin/
	wget "https://registry.npmjs.org/@esbuild/linux-x64/-/linux-x64-0.25.3.tgz" -O /tmp/esbuild.tgz
